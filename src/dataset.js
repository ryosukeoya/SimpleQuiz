    ...
    FrontEnd: [
      ...
      },
      {
        ...
        answers: [
          ...
          'コントラスト：目立たせたものにはコントラストをつけます。ただし、強いコントラストは統一感が崩れます',
    ...
    BackEnd: [
      ...
      },
      {
        ...
        explain: [
          ...
          '間違ってないです！',
          '間違ってないです！',
          'Viewを使わずにAPIを作るだけにすることはよくある使い方です！',
        ],
      },
      {
        question: 'RDBとNoSQLの違いについて正しくないものはどれか？',
        answers: [
          '基本的にトランザクション処理がより強固なものはRDBである',
          'RDBは動的にカラムを追加することができる',
          'NoSQLはスケーラビリティーがRDBよりも優れている',
          'NoSQLは水平分散が可能でサーバーを分散させることができる',
        ],
        correct: 'RDBは動的にカラムを追加することができる',
        explain: [
          '合ってるよ！',
          'RDBでもカラムを追加する方法はありますが、動的にはできません',
          '合ってるよ！',
          '合ってるよ！',
        ],
      },
      {
        question: 'AWSのサービスについての説明の中で正しくない説明をしているものはどれか？',
        answers: [
          'EC2はサーバーに必要なものを一式借りることができる仮想サーバーを提供するサービスである',
          'S3はオブジェクトストレージサービスである',
          'VPCは仮想ネットワーク環境を提供します',
          'Route53はリレーショナルデータベースサービスである',
        ],
        correct: 'Route53はリレーショナルデータベースサービスである',
        explain: [
          'ハードウェアの構成やOSの組み合わせは自分で選択することができる',
          'データのバックアップ先や写真や動画などの保存先として利用されることが多いです',
          'AWSで提供されるリソースのみ置くことができます',
          'これはAmazon RDSのサービスです。Route53はドメインネームサービス(DNS)でURLをIPアドレスに変換する機能を提供します',
        ],
      },
    ],
  },
    ...
    Eva: [
      {
        ...
        answers: ['53万kW', '100万kW', '1億2000万kW', '1億8000万kW'],
        correct: '1億8000万kW',
        explain: [
          'フリーザ第一形態の戦闘力！',
          'フリーザ第二形態の戦闘力!',
